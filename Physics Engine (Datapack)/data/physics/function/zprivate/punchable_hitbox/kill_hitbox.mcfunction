...
scoreboard players operation #Physics Physics.Player.Id = @s Physics.Player.Id
    ...
    execute if score #Physics.EntityInteractionRange Physics matches 5121.. run function physics:zprivate/punchable_hitbox/kill_hitbox_dynamic_range with storage physics:zprivate temp
