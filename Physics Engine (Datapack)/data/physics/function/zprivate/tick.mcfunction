...
# Spawn object hitboxes
    ...
    execute if score #Physics.InteractionCount Physics > #Physics.SuccessfulTeleportCount Physics as @e[type=minecraft:interaction,tag=Physics.Hitbox] unless score @s Physics.Hitbox.Gametime = #Physics.Gametime Physics run function physics:zprivate/punchable_hitbox/kill_leftover
