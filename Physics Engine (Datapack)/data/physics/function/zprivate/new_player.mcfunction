# Init
# (Note): LookingAt.Id is set to 0 because I run an "if 0" check. If it's not initialized, it'll stay unset forever. I could use "unless 1..", but that's slightly slower.
